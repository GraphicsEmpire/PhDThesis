%!TEX root = /Users/pourya/Desktop/research/writings/PhDThesis/Shirazian_Pourya_PhD_2014.tex
...
%The structure of my thesis break-down into several chapters. Each chapter relates to one phase of the project
	\include{chapters/1/01_chapter_intro}
	\include{chapters/2/02_chapter_background}
	\include{chapters/3/03_chapter_cpu_polygonizer}
	\include{chapters/4/04_chapter_gpu_discretization}
	\include{chapters/5/05_chapter_deformable}
      \include{chapters/6/06_chapter_cutting}
	\include{chapters/7/07_chapter_evaluation}
      \include{chapters/8/08_chapter_conclusion}
	%\appendix
