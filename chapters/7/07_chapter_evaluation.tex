...
interactively. The small disjoint parts fall down on the ground due to gravity. Each disjoint part becomes an independant
...
In the next stage a real data-set of an skull tissue is used for the craniotomy operation.
