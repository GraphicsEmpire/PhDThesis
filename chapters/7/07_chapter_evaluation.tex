...
\begin{figure}[H]
  ...
  \includegraphics[width=0.6\linewidth]{figures/evaluation/eggshell05.png}
  \caption{\label{fig:eggshell02}
  {Eggshell model after being drilled by our cutting tool. Top: The first drill, Bottom: 
