...
\begin{figure}[H]
  ...
  % the following command controls the width of the embedded PS file
  % (relative to the width of the current column)
  \includegraphics[width=0.8\linewidth]{figures/cutting/workflow.png}
  \caption{\label{fig:workflow}
  {The main stages in our GPU-accelerated cutting algorithm. See the text for the description of each of these steps.}
}
\end{figure}
...
\begin{figure}[H]
  ...
  % the following command controls the width of the embedded PS file
  % (relative to the width of the current column)
  \includegraphics[width=0.6\linewidth]{figures/cutting/sweep_surface.png}
