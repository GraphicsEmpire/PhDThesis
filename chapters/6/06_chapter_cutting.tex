...
results. Table \ref{table:meshquality} summarises the statistical quality factors before and after cutting the two example meshes. 
...
However, a local remeshing process after the cut specially in the vicinity of the cut region can improve the quality 
