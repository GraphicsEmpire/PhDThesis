...
for non-linear materials \cite{Gibson1997a,Meier2005}. 
...
computations. The small strain assuption is very restrictive. In addition,
during any topogical modifications e.g. in cutting, the pre-computed values has to be recalculated which masks their effectiveness in the overall 
