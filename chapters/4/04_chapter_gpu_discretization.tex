...
last element in both the \textit{EdgeBuffer} and \text{ScannedEdges}. 
...
In order to compute the triangle elements a prefix-sum scan is applied to the \textit{FaceBuffer}
